...
free-page checkpoints (`0xbbff2` on rpi4b, `0x3be49` on virt) plus the
matching boot baseline (`0xbc000` / `0x3be57`), and 0 `ERROR CAUGHT`.
...
current suite covers 38 modules (392 host tests); it
