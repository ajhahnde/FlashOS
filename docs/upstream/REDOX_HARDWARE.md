# Redox OS Hardware Compatibility (Upstream Reference)
...
For the upstream Redox OS contribution process, refer to the
[Redox OS contribution guidelines](https://github.com/redox-os/redox/blob/master/CONTRIBUTING.md).
